...
ActiveRecord::Schema[7.1].define(version: 2024_04_11_211125) do
  ...
  create_table "articles_keywords", id: false, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
